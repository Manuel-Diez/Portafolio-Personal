...
import com.mostrador.Service.VentasService;
...
public class VentasController {
	...
	@PutMapping("{id}")
	public ResponseEntity<ApiResponseDto<Ventas>> update(@PathVariable Long id, @RequestBody Ventas venta) throws Exception{
		try {
