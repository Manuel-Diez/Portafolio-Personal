package com.mostrador.Controller;
...
import com.mostrador.Service.DescripcionVentasService;
import com.mostrador.entity.DescripcionVentas;
import com.mostrador.utils.ApiResponseDto;

@RequestMapping("descripcion-ventas")
@RestController
@CrossOrigin
public class DescripcionVentasController {
	...
	@PutMapping("{id}")
	public ResponseEntity<ApiResponseDto<DescripcionVentas>> update(@PathVariable Long id, @RequestBody DescripcionVentas descripcionVentas) throws Exception{
		try {
