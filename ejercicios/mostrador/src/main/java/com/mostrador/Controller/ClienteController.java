...
import com.mostrador.Service.ClienteService;
...
public class ClienteController {
	...
	@PutMapping("/{id}")
	public ResponseEntity<ApiResponseDto<Clientes>> update(@PathVariable Long id, @RequestBody Clientes cliente) throws Exception{
		try {
