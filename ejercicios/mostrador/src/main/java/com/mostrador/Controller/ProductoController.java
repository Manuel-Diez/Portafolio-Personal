...
import com.mostrador.Service.ProductoService;
import com.mostrador.entity.Productos;
...
public class ProductoController {
	...
	@PutMapping("/{id}")
	public ResponseEntity<ApiResponseDto<Productos>> update(@PathVariable Long id, @RequestBody Productos producto) throws Exception{
		try {
